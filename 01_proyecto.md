...
*   **App Paciente / Autogestión:** Cliente oficial autenticado con **Clave Única**. Permite (1) actualizar la zona privada de *su* TPIM con el payload firmado del RVN; (2) configurar y consentir el texto de la zona pública. No es la app de un transeúnte: solo el dueño/tutor autenticado escribe en su chip.
