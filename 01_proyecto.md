...
*   **Clientes y SDK de Integración:** Además de las apps oficiales (personal clínico, civiles y primeros respondedores), la MIMF expone **SDK / API / OAuth** para que un hospital o proveedor integre ABAC y consulta de atributos directamente en su propio sistema, sin obligar a usar las aplicaciones de la red.
